...
/**
 * @info ProjectAdvancedView (05 Mar 2021) // CREATION DATE
 *
 * @comment ProjectAdvancedView - React component.
 *
...
const ProjectAdvancedView = (props) => {
  ...
  */
  ...
  // [TEMPLATE]
  return <div>ProjectAdvancedView</div>
}

// [PROPTYPES]
ProjectAdvancedView.propTypes = {}
